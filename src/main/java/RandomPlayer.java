...
public class RandomPlayer {
    ...
    public int getWinner(int[][] state) {
        if (state[0][0] == state[0][1] && state[0][0] == state[0][2] && state[0][0] != 0) return state[0][0];   //First row
        if (state[1][0] == state[1][1] && state[1][0] == state[1][2] && state[1][0] != 0) return state[1][0];   //Second row
        if (state[2][0] == state[2][1] && state[2][0] == state[2][2] && state[2][0] != 0) return state[2][0];   //Third row
        if (state[0][0] == state[1][0] && state[0][0] == state[2][0] && state[0][0] != 0) return state[0][0];   //First col
        if (state[0][1] == state[1][1] && state[0][1] == state[2][1] && state[0][1] != 0) return state[0][1];   //Second col
        if (state[0][2] == state[1][2] && state[0][2] == state[2][2] && state[0][2] != 0) return state[0][2];   //Third col
        if (state[0][0] == state[1][1] && state[0][0] == state[2][2] && state[0][0] != 0) return state[0][0];   //Main diag
        if (state[0][2] == state[1][1] && state[0][2] == state[2][0] && state[0][2] != 0) return state[0][2];   //Second diag
        return 0;
    }
